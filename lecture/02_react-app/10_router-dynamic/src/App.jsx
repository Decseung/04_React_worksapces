  ...
  return (
    <>
      <nav>
        ...
        <Link to="/profile/1">1번 회원의 프로필페이지</Link> |{" "}
        <Link to="/profile/2">2번 회원의 프로필페이지</Link> |{" "}
        <Link to="/practice/it/2">Practice2</Link> |{" "}
        <Link to="/practice/it/5">Practice5</Link> |{" "}
        <Link to="/practice/history/1">Practice History</Link> |{" "}
        <Link to="/practice/art/5">Practice Art</Link>
      </nav>
      <main>
        <Routes>
          ...
          <Route path="/practice/:category/:uid" element={<Practice />} />
        </Routes>
      </main>
    </>
  );
